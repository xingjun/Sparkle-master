...
//    if ([[SUUpdater sharedUpdater] forceUpdate]) {
        if ([aButtonTitle isEqualTo:SULocalizedString(@"Installing update...", @"")] || [aButtonTitle isEqualTo:SULocalizedString(@"Checking for updates...", nil) ] || [aButtonTitle isEqualTo:SULocalizedString(@"Ready to Install", nil)]|| [aButtonTitle isEqualTo:SULocalizedString(@"Install and Relaunch", nil)]) {
